<div class="modal" id="modalThnx">
    <div class="modal-content">
        ...
        <div class="modal_thnx">
            <h2>Спасибо!</h2>
            <p>Мы получили заявку и скоро свяжемся с вами</p>
            <button id="close-thnx" class="close-thnx" type="button">Хорошо</button>
        </div>
    </div>
    <style>
        .modal_thnx h2 {
